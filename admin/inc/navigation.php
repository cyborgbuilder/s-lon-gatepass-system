...
.brand-text{
  font-size: 17px;
      ...
      <aside class="main-sidebar  elevation-4 sidebar-no-expand">
        ...
        <img src="./logo.png" alt="Store Logo" class="brand-image img-circle elevation-3 bg-black" style="width: 1.8rem;height: 1.8rem;max-height: unset;object-fit:scale-down;object-position:center center">
        <span class="brand-text font-weight-bold">S-Lon PVT Ltd.</span>
        </a>
